 ...
 */
export declare function reserveSeatsTemporarily(args: ReserveSeatsTemporarilyArgs): Promise<ReserveSeatsTemporarilyResult>;
/**
 * 座席仮予約削除in
 ...
 */
export declare function deleteTmpReserve(args: DeleteTmpReserveArgs): Promise<void>;
/**
 * 座席予約状態抽出in
 ...
 */
export declare function getStateReserveSeat(args: GetStateReserveSeatArgs): Promise<GetStateReserveSeatResult>;
/**
 * 空席状況in
 ...
 */
export declare function updateReserve(args: UpdateReserveArgs): Promise<UpdateReserveResult>;
/**
 * 座席単位削除
 ...
 * @returns {Promise<void>}
 */
export declare function deleteReserve(args: DeleteReserveArgs): Promise<void>;
/**
 * 購入チケット内容抽出in
 */
