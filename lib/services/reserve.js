...
function countFreeSeat(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            listDate: body.list_date.map((date) => {
                return {
                    dateJouei: date.date_jouei,
                    listPerformance: date.list_performance.map((performance) => {
                        return {
...
function updTmpReserveSeat(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            listTmpReserve: body.list_tmp_reserve.map((tmpReserve) => {
                return {
...
function stateReserve(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            listTicket: body.list_ticket.map((ticket) => {
                return {
