declare module "@motionpicture/coa-service" {
    module coaService {
        function initialize(args: {
            endpoint: string;
            refresh_token: string;
        }): void;
        namespace findTheaterInterface {
            interface Args {
                theater_code: string;
            }
            interface Result {
        ...
        namespace findFilmsByTheaterCodeInterface {
            interface Args {
                theater_code: string;
            }
            interface Result {
        ...
        namespace findScreensByTheaterCodeInterface {
            interface Args {
                theater_code: string;
            }
            interface Result {
        ...
        namespace findPerformancesByTheaterCodeInterface {
            interface Args {
                theater_code: string;
                begin: string;
                end: string;
        ...
        namespace reserveSeatsTemporarilyInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace deleteTmpReserveInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace getStateReserveSeatInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace countFreeSeatInterface {
            interface Args {
                theater_code: string;
                begin: string;
                end: string;
        ...
        namespace salesTicketInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace updateReserveInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace deleteReserveInterface {
            interface Args {
                theater_code: string;
                date_jouei: string;
                title_code: string;
        ...
        namespace stateReserveInterface {
            interface Args {
                theater_code: string;
                reserve_num: string;
                tel_num: string;
